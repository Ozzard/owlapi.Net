...
namespace org.semanticweb.owlapi.util
{
    /**
     * A set of personalized preconditions.
     */
    public static class OWLAPIPreconditions
    {
        /**
         ...
         */
        public static T VerifyNotNull<T>(T? o) where T : class
        {
            return VerifyNotNull(o, "value cannot be null at this stage");
        }
         ...
         * @throws IllegalStateException if object is null
         */
        public static T VerifyNotNull<T>(T? o, string message) where T : class
        {
            if (o == null)
            {
         ...
         */
        public static T CheckNotNull<T>(T? o) where T : class
        {
            return CheckNotNull(o, () => "this variable cannot be null");
        }
         ...
         * @throws NullPointerException if object is null
         */
        public static T CheckNotNull<T>(T? o, string message) where T : class
        {
            if (o == null)
            {
         ...
         * @throws NullPointerException if object is null
         */
        public static T CheckNotNull<T>(T? o, Func<string> message) where T : class
        {
            if (o == null)
            {
                throw new NullReferenceException(message());
